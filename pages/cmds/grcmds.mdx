...
**Description:** <p>Initiates a break for the grinder mentioned `<@user>`, specifying the break duration `<duration>` (format needs to be an integer). The maximum number of break days available is 24</p>
