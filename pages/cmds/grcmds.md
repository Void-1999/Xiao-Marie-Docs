...
- `<tier_name>`: The name of the tier you want to demote to. ==Case Sensitive==
...
**Description:** <p>Initiates a break for the grinder mentioned `<@user>`, specifying the break duration `<duration>` (format needs to be an integer).<br>The maximum number of break days available is 24</p>
